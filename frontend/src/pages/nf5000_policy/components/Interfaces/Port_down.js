...
const Port_down = ({  red, id, isAddPort, isEditEGroup, portid, portName,portConfig, canWrite, ...props }) => {
    ...
    //Styles
    const fill = red ? 'button2_blue' : 'button2_white'
    ...
    return (
        ...
        <div className={styles.blank_G}></div>
        </>
    )
}

export default Port_down
