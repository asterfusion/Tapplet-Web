...
export default class Ipset extends Component{
    constructor(props){
        super(props)
    }
    render(){
        ...
        return(
            ...
            <Form.Item label={formatMessage({id:"app.policy.sip"})}>
                ...
                })(<Input disabled={Mode == "scan"} style={{width:137}} placeholder = {Mode !== "scan" ? "(e.g. 192.168.1.1)" : ""} />)}     
            </Form.Item>
            ...
            <Form.Item label={formatMessage({id:"app.policy.dip"})}>
                {getFieldDecorator("dip",{
                    ...
                    rules: [{pattern:RegexPattern.ipv4, message: formatMessage({id:'app.err.ipv4'})}],
                })(<Input disabled={Mode == "scan"} style={{width:137}} placeholder = {Mode !== "scan" ? "(e.g. 192.168.1.2)" : ""} />)}     
            </Form.Item>
