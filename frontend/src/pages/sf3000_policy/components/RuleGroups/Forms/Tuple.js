                ...
                <Form.Item label={formatMessage({id:"app.policy.sip"})} wrapperCol={{span:15}}>
                    <Form.Item style={{display:'inline-block', marginBottom:"0"}}>
                            {getFieldDecorator("start_sip",{
                                ...
                                rules: [{pattern:RegexPattern.ipv4, message: formatMessage({id:'app.err.ipv4'}) }],
                            })(<Input disabled={Mode == "scan"} placeholder = {Mode !== "scan" ? "e.g. 192.168.1.1" : ""} />)}     
                    </Form.Item>
                    ...
                    <Form.Item style={{display:'inline-block',marginLeft:10, marginBottom:"0"}}>
                            {getFieldDecorator("end_sip",{
                                ...
                                rules: [{pattern:RegexPattern.ipv4, message: formatMessage({id:'app.err.ipv4'}) }],
                            })(<Input disabled={Mode == "scan"} placeholder = {Mode !== "scan" ? "e.g. 192.168.1.203" : ""} />)}     
                    </Form.Item>
                </Form.Item>
                ...
                <Form.Item label={formatMessage({id:"app.policy.dip"})} wrapperCol={{span:15}}>
                    <Form.Item style={{display:'inline-block', marginBottom:"0"}}>
                            {getFieldDecorator("start_dip",{
                                ...
                                rules: [{pattern:RegexPattern.ipv4, message: formatMessage({id:'app.err.ipv4'}) }],
                            })(<Input disabled={Mode == "scan"} placeholder = {Mode !== "scan" ? "e.g. 192.168.2.1":""} />)}     
                    </Form.Item>
                    <span style={{display:'inline-block',textAlign:'center', marginLeft:10}}> - </span>
                    <Form.Item style={{display:'inline-block',marginLeft:10, marginBottom:"0"}}>
                            {getFieldDecorator("end_dip",{
                                ...
                                rules: [{pattern:RegexPattern.ipv4, message: formatMessage({id:'app.err.ipv4'}) }],
                            })(<Input disabled={Mode == "scan"} placeholder = {Mode !== "scan" ? "e.g. 192.168.2.203" : ""}/>)}     
                    </Form.Item>
                </Form.Item>
