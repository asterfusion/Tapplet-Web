export default {
  ...
  'menu.statistics': 'Interface Statistics',
  'menu.usermanage': 'User Management',
  'menu.usermanage.user': 'User Configuration',
  'menu.usermanage.role': 'Role Configuration',
  'menu.policy': 'Forwarding Policy',
  'menu.system': 'System Configuration',
  'menu.system.version': 'Version',
  'menu.system.time': 'Time Zone Configuration',
